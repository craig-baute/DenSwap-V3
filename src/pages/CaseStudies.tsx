...
import { CaseStudy } from '../components/CaseStudyCMS';
import { CaseStudyProject } from '../components/CaseStudyCMS';
import { TrendingUp, Building, Users, DollarSign, Calendar, MapPin, ArrowRight, CheckCircle, BarChart3, Target, Clock } from 'lucide-react';
...
const CaseStudies = () => {
  ...
  useEffect(() => {
    ...
    const mockFeaturedProject = {
      ...
      timeline: "12 months",
      testimonial: "The transformation exceeded our expectations. We went from struggling with vacancies to having a waiting list of members.",
    ...
    const mockHighlightedProjects = [
      {
        id: 2,
        title: "Suburban Office Complex",
        subtitle: "Mixed-use coworking success",
        location: "Austin, TX",
        buildingSize: "15,000 sq ft",
        image: "/images/case-study-2.jpg",
        challenge: "Outdated office complex with poor tenant retention",
        results: {
          occupancy: "88%",
          noiIncrease: "145%"
        },
        testimonial: "The ROI was better than we ever imagined possible."
      },
      {
        id: 3,
        title: "Historic Building Revival",
        subtitle: "Preserving character while maximizing returns",
        location: "Portland, OR",
        buildingSize: "12,000 sq ft",
        image: "/images/case-study-3.jpg",
        challenge: "Historic building with unique layout challenges",
        results: {
          occupancy: "92%",
          noiIncrease: "165%"
        },
        testimonial: "They found a way to honor the building's history while creating modern workspace."
      }
    ];
